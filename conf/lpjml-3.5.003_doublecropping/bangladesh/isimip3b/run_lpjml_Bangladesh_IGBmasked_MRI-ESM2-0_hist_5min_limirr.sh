...
#SBATCH --job-name=lpjml_Bangladesh_IGBmasked_MRI-ESM2-0_hist_5min_limirr.conf
#-----------------------------Required resources-----------------------
#SBATCH --qos=std
#SBATCH --time=30
#SBATCH --ntasks=16
...
mpirun "$LPJROOT/bin/lpjml" /home/WUR/danke010/mycode/lpjml_tools/conf/lpjml-3.5.003_doublecropping/bangladesh/isimip3b/lpjml_run.conf
