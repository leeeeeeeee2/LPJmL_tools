...
histdir='/home/danke010/scratch/Bangladesh/output/run_39394415_GFDL_hist'
cd $histdir
...
#cdo timmean -selyear,1971/2000 pft_harvest_bd.nc pft_harvest_bd_1971-2000_timmean.nc
# the historical run only contains 27 years, 1979-2005, so let's just average over the entire run
# irrigation
cdo timmean mirrig_bd_fldmean.nc mirrig_bd_1979-2005_timmean.nc 
...
# harvest
cdo timmean pft_harvest_bd.nc pft_harvest_bd_1979-2005_timmean.nc
# discharge
cdo timmean -yearmean mdischarge_brahmaputra_in.nc mdischarge_brahmaputra_in_1979-2005_timmean.nc
cdo timmean -yearmean mdischarge_ganges_in.nc mdischarge_ganges_in_1979-2005_timmean.nc
...
# spatial patterns
cdo timmean -ifthen $bdmask mirrig.nc mirrig_bd_masked_1979-2005_timmean.nc
...
cdo div -yearavg mirrig_bd_fldmean.nc $histdir/mirrig_bd_1979-2005_timmean.nc mirrig_bd_rcp8_div_hist.nc
...
cdo fldmean -ifthen $bdmask pft_harvest.grid.bin pft_harvest_bd.nc
# relative to historical run
cdo div pft_harvest_bd.nc $histdir/pft_harvest_bd_1979-2005_timmean.nc pft_harvest_bd_rcp8_div_hist.nc
...
cdo remapnn,lon=88.075/lat=24.609 mdischarge.nc mdischarge_ganges_in.nc
# relative to historical run
cdo div -yearmean mdischarge_brahmaputra_in.nc $histdir/mdischarge_brahmaputra_in_1979-2005_timmean.nc mdischarge_brahmaputra_in_yearmean_rcp8_div_hist.nc
cdo div -yearmean mdischarge_ganges_in.nc $histdir/mdischarge_ganges_in_1979-2005_timmean.nc mdischarge_ganges_in_yearmean_rcp8_div_hist.nc

# spatial patterns
cdo timmean -selyear,2070/2099 -ifthen $bdmask mirrig.nc mirrig_bd_masked_2070-2099_timmean.nc
cdo div mirrig_bd_masked_2070-2099_timmean.nc $histdir/mirrig_bd_masked_1979-2005_timmean.nc mirrig_bd_masked_2070-2099_rcp8_div_hist.nc
